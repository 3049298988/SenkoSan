...
Costume = {
	...
	setCostume = function (costume, regenerateModels)
		...
		elseif costume == "KAPPOGI" then
			...
			models.models.main.Avatar.LowerBody.Apron:setUVPixels(32, 0)
...
models.models.main.Avatar.Head.CHalloweenH:newBlock("halloween_pumpkin"):setBlock(CompatibilityUtils:checkBlock("minecraft:carved_pumpkin")):pos(-5.5, 0.6, 7.5):rot(20, 90, 0):scale(0.15)
