...
Skull = {
	...
	generateSkullFigureModel = function (self)
		...
		elseif self.CurrentSkull == 3 then
			...
			for _, modelPart in ipairs({models.models.skull_figure.Avatar.UpperBody.Body.Bells, models.models.skull_figure.Avatar.UpperBody.Arms.RightArm.RightArmBottom.RightSleeveBase, models.models.skull_figure.Avatar.UpperBody.Arms.LeftArm.LeftArmBottom.LeftSleeveBase, models.models.skull_figure.Avatar.LowerBody.Apron}) do
				modelPart:remove()
			end
		...
		elseif self.CurrentSkull == 6 then
			...
			for _, modelPart in ipairs({models.models.skull_figure.Avatar.Head.FaceParts.Mouth, models.models.skull_figure.Avatar.UpperBody.Body.Bells, models.models.skull_figure.Avatar.LowerBody.Apron}) do
				modelPart:remove()
			end
